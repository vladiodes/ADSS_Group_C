...
class RecordControllerTest {
    ...
    void showExpItems() {
        try{
            ...
            Report report = this.recordController.showExpItems(categories);
 ...
 */
    ...
    void showMinAmountItems() {
        ...
        ArrayList<Category> categories = new ArrayList();
        Category cat = new Category("meat",1,null);
        Item item1 = cat.addItem(202,"chicken","osem",1,0,50, LocalDate.of(2021,4,9),28,30,40);
        Item item2 = cat.addItem(255,"burger","elit",300,1,50, LocalDate.of(2021,4,9),30,60,80);
        categories.add(cat);
        ArrayList<Item> toCompare = new ArrayList<>();
        toCompare.add(item1);
    ...
    void getSalesReportAndAddSale() {
        try
        {
            ArrayList<Category> categories = new ArrayList();
            Category cat = new Category("meat",1,null);
            Item item1 = cat.addItem(202,"chicken","osem",100,0,50, LocalDate.of(2021,4,9),28,30,40);
            Item item2 = cat.addItem(255,"burger","elit",300,1,50, LocalDate.of(2021,4,9),30,60,80);
            categories.add(cat);
